...
from helper_func import MyResNet18,CalcExpectation,GetResNet101,EnsamblePred,EnsamblePredForAUC,GetNumOfUniqValues_torch_ver
...
for Epoch in range(EPOCHS):
    for batch_i, [batch,labels,weights] in enumerate(train_dataloader):
        ...
        outputs = CalcExpectation(outputs)
        ...
        with torch.no_grad():
            ...
            outputs_val = CalcExpectation(outputs_val)
